...
/**
  ...
  * (2010): 849-872.
  *
  * NOTE: The order in which values are counted could affect Bucket distribution
  * and counts as StreamingHistogram instances are merged, due to the
  * way in which bucket boundaries are defined. This
  */
